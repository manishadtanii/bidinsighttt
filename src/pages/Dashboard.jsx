            ...
            <div className="flex justify-between items-center">
              ...
              <div className="dashboard-middle">
                {loading ? (
                  ...
                  <div className="flex gap-3 text-[1em]">
                    {middle.map((item) => (
                      <BgCover key={item.id} title={item.title} description={item.description}>
              ...
              <div className="feature-right">
                <div className="flex gap-4 items-center">
                  ...
                  <BgCover title={"Save Search"} description={'Bookmark bids you’re interested in so you can check them out later.'}>
                    <div

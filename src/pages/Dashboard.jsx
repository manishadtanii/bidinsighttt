  ...
  useEffect(() => {
    async function fetchBids() {
      ...
      try {
        ...
        const res = await api.get(`https://apibid.collegedwarka.com/api/bids/?pageSize=25&page=${currentPage}&bid_type=Active`, {
          headers: token ? { Authorization: `Bearer ${token}` } : {},
        });

        setCount(res.data.count);
        console.log(`https://apibid.collegedwarka.com/api/bids/?pageSize=${currentPage}5&page=1&bid_type=Active`)
